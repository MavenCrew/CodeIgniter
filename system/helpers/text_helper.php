...
if (!function_exists('ascii_to_entities')) {
    ...
    {
        $out = '';
        for ($i = 0, $s = strlen($str), $count = 1, $temp = []; $i < $s; $i++) {
            $ordinal = ord($str[$i]);
...
if (!function_exists('highlight_code')) {
    ...
    function highlight_code($str)
    {
        ...
        return str_replace(['phptagopen', 'phptagclose', 'asptagopen', 'asptagclose', 'backslashtmp', 'scriptclose'],
                    ['&lt;?', '?&gt;', '&lt;%', '%&gt;', '\\', '&lt;/script&gt;'],
                    $str);
    }
}
...
if (!function_exists('word_wrap')) {
    ...
    function word_wrap($str, $charlim = 76)
    {
        ...
        return str_replace(['{unwrap}', '{/unwrap}'], '', $output);
    }
}
